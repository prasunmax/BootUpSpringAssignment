...
@EnableJpaRepositories(basePackages = {
		"prasun.springboot.order" }, entityManagerFactoryRef = "mongoEntityManager", transactionManagerRef = "mongoTransactionManager")
...
public class MongoDbConfig extends AbstractMongoClientConfiguration{
	...
	public LocalContainerEntityManagerFactoryBean mongoEntityManager() throws Throwable {
		...
		entityManager.setPackagesToScan("prasun.springboot.order.entity");// This is required so that the hibernate
