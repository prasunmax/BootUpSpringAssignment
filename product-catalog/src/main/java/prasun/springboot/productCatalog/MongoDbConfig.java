...
@EnableJpaRepositories(basePackages = {
		"prasun.springboot.productCatalog" }, entityManagerFactoryRef = "mongoEntityManager", transactionManagerRef = "mongoTransactionManager")
...
public class MongoDbConfig extends AbstractMongoClientConfiguration{
	...
	public LocalContainerEntityManagerFactoryBean mongoEntityManager() throws Throwable {
		...
		entityManager.setPackagesToScan("prasun.springboot.productCatalog.entity");// This is required so that the hibernate
