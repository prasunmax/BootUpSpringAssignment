...
@EnableJpaRepositories(basePackages = {
		"prasun.springboot.price" }, entityManagerFactoryRef = "mongoEntityManager", transactionManagerRef = "mongoTransactionManager")
...
public class MongoDbConfig extends AbstractMongoClientConfiguration{
	...
	public LocalContainerEntityManagerFactoryBean mongoEntityManager() throws Throwable {
		...
		entityManager.setPackagesToScan("prasun.springboot.price.entity");// This is required so that the hibernate
